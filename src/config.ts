...
export const siteConfig: SiteConfig = {
	...
	favicon: [
		...
		{
			src: "/favicon/web-app-manifest-192x192", // Path of the favicon, relative to the /public directory
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		{
			name: "私信",
			icon: "fa6-regular:envelope", // https://icones.js.org/collection/fa6-regular
			// icones.js 搜索想要的图标。例如 QQ 可以填写 fa6-brands:qq。
			// Fuwari 默认支持 fa6-brands、fa6-regular、fa6-solid、material-symbols 等类型，
			// 必要时也可以在 astro.config.mjs 中继续扩展。
			url: "https://www.nodeseek.com/notification#/message?mode=talk&to=9379",
		},
	],
};
